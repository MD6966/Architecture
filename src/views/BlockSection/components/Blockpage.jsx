import { Box, Button, CardContent, CardMedia, Divider, Grid, Typography, useTheme } from '@mui/material'
...
const Blockpage = () => {
    ...
    return (
        <>
                        ...
                        <Grid lg={4} sx={{ marginTop: '30px', }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '5px', paddingLeft: '20px' }}>
                                <Box>
                                    ...
                                    <Typography sx={{ textAlign: 'start' }}>{blockData.description}</Typography>
                                </Box>
                                <Box sx={{ marginLeft: '30%', marginTop: '50px' }}>
                                    <button style={{ backgroundColor: '#0077b6', color: 'white', padding: '7px 15px', border: 'none' }}>Download</button>
                                </Box>
                                <Box>
                                    <Divider />
                                </Box>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'start', alignItems: 'center', gap: '10px', fontSize: '20px', marginTop: '30px', flexWrap: 'wrap' }}>
            ...
            <Box sx={{ padding: '100px 150px' }}>
                <Typography sx={{ fontSize: '20px', fontWeight: 500 }}>Similar Examples</Typography>
